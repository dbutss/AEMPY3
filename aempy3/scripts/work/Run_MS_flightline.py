...
n0=1
betamin=np.log10(0.001) #0.001
betamax=np.log10(0.001)   #10
n1=1
tau1min=np.log10(60.)
tau1max=np.log10(60.)
beta = np.logspace(betamin,betamax,n0)
...
# MGS quasi-inversion with deterministic method 
...
#               # Generalized Inverse
            ...
            if n0*n1 == 1: 
                ...
                if out: 
                   print \
                   ( ' Min GCV at beta = %7.3g, tau1 - %7.3g ' % (g0,g1))
                ...
                if out:
                   print \
                   ( ' Min UPR at beta = %7.3g, tau1 - %7.3g ' % (g0,g1))
