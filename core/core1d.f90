...
!  shift from teslas to nanoteslas or nT/s.
 ...
 !     WRITE(*,'(/A/11G12.4/G12.4)') 'in-line ', bfdd(:,3)
 !     WRITE(*,'(/A/11G12.4/G12.4)') 'in-line ', bfdd(:,3)
 !     WRITE(*,'(/A/11G12.4/G12.4)') 'vertical ',bfdd(:,1)
 !     WRITE(*,'(/A/11G12.4/G12.4)') 'bfdd', bfdd
...
!------------------------------------------------------------------------
     ...
     &                       Mu0 = 12.56637D-7 , Exp_tol = 80.D0
      ...
      REAL(KIND=8)   xp0 , sig0(nlyr) , thkd(nlyr-1) , lmbda , zrfd ,    &
